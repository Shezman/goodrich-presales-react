      ...
      <div>
        ...
        <section id="invest-performance">
          <div className="container">
            <div className="row">
              <div className="col-md-12">
                <div class="invest-performance inner-content">
                  <p>
                  ...
                  <p>
                    As sports fans ourselves, we didn’t find the current
                    offerings on the market all that appealing. We could join a
                    fantasy league once a year, spend all year tweaking a roster
                    of players that we may or may not care about, for the chance
                    to win back our entry fee at the end of the year. The ratio
                    of time we spend on our fantasy league compared to the
                    chance of winning at the end of the year is very low.
                    Alternatively, we can place a bet in Las Vegas or Atlantic
                  ...
                  <p>
                    ...
                    the way sports works (yes, even in soccer, there are penalty
                    kick tie breakers to determine champions). But we know
                  ...
                  <p>
                    At GoodRich, we run our company like how we would run a
                    sports team. Our founding partners come from all kinds of
                    backgrounds and nationalities, and we expect our employees
                  ...
                  <p>
                    ...
                    the team. A point guard is different from a power forward,
                    who is different from a center, and a team cannot win
                    without the right combination of assists, rebounds, and
                    blocks that ultimate lead to points on the scoreboard. When
                    players work together towards a common goal, the results are
                    often very beautiful and rewarding. The way Jordan played
                    with Pippen was mesmerizing. The three rings that Kobe and
                    Shaq won together was as beautiful as their eventual divorce
                  ...
                  <p>
                    We also believe that teamwork beats individualism, and we
                    want to cultivate a team-first mentality in our company. Our
                  ...
                  <p>
                    We are in the sports business. We created a whole new way
                    for sports fans to involve themselves in their favorite
                    team’s success. And we didn’t do it for the sake of doing
                    it. We did it to be a successful enterprise that brings a
